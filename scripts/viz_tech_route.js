  ...
  const STEPS = [
    ...
    },
    {
      ...
      detail: "把前滩太古里的「楼层 × 14 业态品牌数」当作目标向量，对所有高端候选做余弦相似度 MHI_sf。" +
        "MHI_sf 越接近 1 越值得作为对照锚点。在两个主要候选中：兴业太古汇 MHI_sf = 0.8385，" +
        "环贸 iapm = 0.8274。最终选定兴业太古汇为前滩的深度对照对象，环贸 iapm 作为第二候选落选。",
      owner: "黄"
    },
    {
      key: "field",
      ...
      title: "田野定性 + 工具定量",
      brief: "现场踏勘 + 楼层模板距离矩阵",
      detail: "舒带队在前滩太古里与兴业太古汇两家实地踏勘，按动线、视线、广场尺度、店面深度四个维度做结构化观察记录。" +
        "同时陈在工具层用 Wasserstein 距离对两家的楼层模板分布做定量比较，与现场观察交叉验证。",
      owner: "舒 + 陈 + 吴"
    },
    {
      key: "compose",
